...
| Variable | Description |
| -------- | ----------- |
| `DSC_RESOURCE_PATH` | Directories the DSC engine searches for resource manifests. Must include the directory containing the `dsc-databricks` binary and its manifests. |
